...
<head>
    ...
    <style>
        ...
        .code { display: inline-block; font-size: 12px; font-weight: 700; color: #7c2d12; background: #ffedd5; border-radius: 999px; padding: 6px 10px; }
...
<main class="wrap">
    <section class="card">
        <span class="code">5xx Error</span>
        <h1>ただいま一時的にご利用できません</h1>
        <p>時間をおいて再度アクセスしてください。操作内容は保存されていない場合があります。</p>
        <p>繰り返し発生する場合は、日時と操作内容を管理者へお知らせください。</p>
        <div class="actions">
