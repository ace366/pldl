<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800">学校を編集</h2>
    </x-slot>
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('admin.schools.update', $school) }}">
                    ...
                    <label class="mt-4 flex items-center gap-2 text-sm text-gray-700">
                        <input type="checkbox" name="is_active" value="1" @checked(old('is_active', $school->is_active)) class="rounded border-gray-300">
                        有効
                    </label>
