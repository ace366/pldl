...
set REMOTE_APP_DIR=/home/top-ace-picard/www/pldl
set REMOTE_TMP_DIR=/home/top-ace-picard/www/tmp/pldl_deploy
set REMOTE_SCRIPT=/home/top-ace-picard/www/tmp/pldl_deploy/remote_deploy_pldl.sh
REM ====================
